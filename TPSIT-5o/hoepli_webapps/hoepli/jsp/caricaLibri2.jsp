...
<HR>
<jsp:useBean id="libri" class="mieiBean.ScelteDBDerby" />
<H3><span class="style1">Ti suggerisco i seguenti libri di</span><font color="#0000FF">:
...
</font><span class="style1">editi da</span><font color="#0000FF">
  <% out.println( request.getParameter("editoreScelto") );%>
  ...
  <jsp:setProperty name="libri" property="lingua" 
    ...
    <!-- setto nel Bean la variabile editore con la scelta dell'utente -->
  <jsp:setProperty name="libri" property="editore" 
                                value= "<%= request.getParameter(\"editoreScelto\") %>" />
  
  <!-- ricevo dal Bean la stringa di risposta con l'elenco dei libri -->
  <jsp:getProperty name="libri" property="elenco"/>
<HR>
<a href="scegliDBBeanDerby.jsp">ritorna alla pagina di scelta</a><b> . </b>
