...
public class ServletCercaLibri1 extends HttpServlet{ 
  ...
  throws  ServletException
  {
    ...
    elencoLibri.addElement(new Libri("Una vita","Italo Svevo","Rusconi","romanzo"));
    elencoLibri.addElement(new Libri("Il fu Mattia Pascal","Luigi Pirandello","Rusconi","romanzo"));
    elencoLibri.addElement(new Libri("I promessi sposi","Alessandro Manzoni","Rusconi","romanzo"));
    elencoLibri.addElement(new Libri("Gli incubi di Dylan Dog","Tiziano Sclavi","Sergio Bonelli","fumetti"));   
    elencoLibri.addElement(new Libri("Corto fucile","Carlo Berardi","Sergio Bonelli","fumetti"));   
  }
