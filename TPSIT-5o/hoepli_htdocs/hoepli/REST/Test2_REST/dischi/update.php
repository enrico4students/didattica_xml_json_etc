<?php
  ...
  $disco->setNRcatalogo($data->NRcatalogo);               // analisi dei dati 
  ...
  if($disco->update()){
    ...
    echo json_encode(array("risposta" => "disco aggiornato"));
  }
  else{                          //503 Servizio non disponibile
    http_response_code(503);
    echo json_encode(array("risposta" => "Impossibile aggiornare il disco"));
  }
?>
