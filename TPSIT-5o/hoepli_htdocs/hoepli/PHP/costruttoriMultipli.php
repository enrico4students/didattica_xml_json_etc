...
$data1 = new AggiornaData();             // timestamp impostato al momento corrente
echo 'Data corrente 1:      ', $data1->get(),'<BR>';
sleep(2);
$data1 = new AggiornaData();             // timestamp impostato al momento corrente
echo 'Data corrente 1:      ', $data1->get(),'<BR>';

$data2 = new AggiornaData(1577487600);   // timestamp impostato al 28 dicembre 2019
echo 'Data corrente 2:      ', $data2->get(),'<BR>';
$data3 = new AggiornaData('12/28/2019'); // timestamp impostato al 28 dicembre 2019
echo 'Data corrente 3:      ', $data3->get(),'<BR>';
$data4 = new AggiornaData(28, 12, 2019);   // timestamp impostato al 28 dicembre 2019
echo 'Data corrente 4:      ', $data4->get(),'<BR>';
sleep(1);
$data5 = new AggiornaData(9, 3);         // errore