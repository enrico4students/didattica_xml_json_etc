...
Da notare che i quattro campi dell'indirizzo potrebbero essere riuniti in un unico campo (va modificato di conseguenza lo script). 
Qui sono distinti per questione di efficienza.
...
<body>
	...
	<div id="istruzioni"><span style="font-weight:bold;">Istruzioni:</span> all'apertura della pagina si usano le coordinate che abbiamo inserito di default (indirizzo di Como, Italia).<br />
